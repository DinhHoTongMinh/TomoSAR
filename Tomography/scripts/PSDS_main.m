...
if ComSAR_flag
    % ComSAR is friendly Big Data processing
    % Compressed version 
    ComSAR_estimator(slcstack.datastack,slcstack.filename,...
        interfstack.datastack,interfstack.filename, SHP, InSAR_path, BroNumthre, ...
          Cohthre, miniStackSize, Cohthre_slc_filt, Unified_flag, InSAR_processor)                  
else 
    % PSDS is heavy on memory use due to full covariance estimation
